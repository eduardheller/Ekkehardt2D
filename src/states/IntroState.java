	...
	public void update(Graphics2D g,double delta) {
		...
		switch(_talkNmb){
			...
			case 1:
				_talk1.show(g);
				_bmf2.drawString(g, "Unbekannter Toter Typ", 100, 370);
				_bmf.drawString(g, "Mit meiner Zombiearmee werde", 70, 400);
				_bmf.drawString(g, "ich die Welt zerstoeren", 70, 420);
				break;
			case 2: 
				_talk1.show(g);
				_bmf2.drawString(g, "Unbekannter Toter Typ", 100, 370);
				_bmf.drawString(g, "Niemand wird mich aufhalten", 70, 400);
				break;
			case 3:
				GameStateManager.getInstance().setState("INTRO_HEROES");
				break;
		}
